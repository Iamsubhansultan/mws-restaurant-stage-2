...
initMap = () => {
  ...
  L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.jpg70?access_token={mapboxToken}', {
    mapboxToken: 'pk.eyJ1Ijoic3ViaGFuc3VsdGFuIiwiYSI6ImNqajcwMWxhdDF5cmQzcG0xODFsNDJscmsifQ.atz5mkuKO3MF2E3qoS9iBg',
    maxZoom: 18,
...
createRestaurantHTML = (restaurant) => {
    ...
    if(restaurant.is_favorite){
        ...
        favouriteButton.setAttribute('aria-label', 'Unmark favourite restaurant');
    } else {
		//console.log( " id "+ restaurant.name);
        favouriteButton.innerHTML = 'Not favourite';
        favouriteButton.classList.remove("favourite");
        favouriteButton.setAttribute('aria-label', 'Mark favourite restaurant');
    }
